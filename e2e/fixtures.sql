...
INSERT OR REPLACE INTO article_reviews
 ...
 ('f6','A','OCBC — credit memo drafting for underwriters','OCBC',
 ...
 ('f8','B','Survey of generative AI adoption plans across European banks',NULL,NULL,NULL,NULL,
  NULL,NULL,NULL,NULL,'high','2026-08-24T00:00:00Z','ai-review'),
 ('f3','B','Supervisory guidance on AI model risk, not a deployment',NULL,NULL,NULL,NULL,
 ...
 ('f11','A','HSBC — machine learning fraud scoring, bank-wide','HSBC',
  'runs a fraud model bank-wide','supervised machine learning',NULL,
 ...
 ('f12','A','HSBC — machine learning fraud scoring, bank-wide','HSBC',
  'scores every retail transaction','supervised machine learning',NULL,
  'machine_learning','p24_fraud_identity_security','in_production',
